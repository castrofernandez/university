xuegu.ElementoRotable = function(partida, x, y, ancho, alto, opciones)
{
	...
	this.rotacion = opciones.rotacion ? opciones.rotacion : 0; // �ngulo acumulativo
	...
	// Distancia del centro a un v�rtice
	...
	function mover(coordenada) {
		...
		// Calculamos el �ngulos entre las 2 rectas
		// 1� recta: centro - punto 1
		// 2� recta: centro - punto 2
        ...
        // Incrementamos el �ngulo entre los 2 puntos
