			...
			<form:form action="save_survey" method="POST"
				...
				<ul class="questions">
					<li>
						...
						<form:hidden path="answer11" id="answer11" value="${SurveyDTO.answer11}" data-audit="yes" />
						<div class="answer" data-answer="answer11"></div>
					</li>
					<li>
						<span class="number">12</span>
						<div class="question"><spring:message code="survey.q12" /></div>
						<form:hidden path="answer12" id="answer12" value="${SurveyDTO.answer12}" data-audit="yes" />
						<div class="answer" data-answer="answer12"></div>
					</li>
					<li>
						<span class="number">13</span>
						<div class="question"><spring:message code="survey.q13" /></div>
						<form:hidden path="answer13" id="answer13" value="${SurveyDTO.answer13}" data-audit="yes" />
				...
				<ul class="questions">
					<li>
						...
						<form:hidden path="answer14" id="answer14" value="${SurveyDTO.answer14}" data-audit="yes" />
						<div class="answer" data-answer="answer14"></div>
					</li>
					<li>
						<span class="number">15</span>
						<div class="question"><spring:message code="survey.q15" /></div>
						<form:hidden path="answer15" id="answer15" value="${SurveyDTO.answer15}" data-audit="yes" />
						<div class="answer" data-answer="answer15"></div>
					</li>
					<li>
						<span class="number">16</span>
						<div class="question"><spring:message code="survey.q16" /></div>
						<form:hidden path="answer16" id="answer16" value="${SurveyDTO.answer16}" data-audit="yes" />
				...
				<ul class="questions">
					<li>
						...
						<form:hidden path="answer17" id="answer17" value="${SurveyDTO.answer17}" data-audit="yes" />
						<div class="answer" data-answer="answer17"></div>
					</li>
					<li>
						<span class="number">18</span>
						<div class="question"><spring:message code="survey.q18" /></div>
						<form:hidden path="answer18" id="answer18" value="${SurveyDTO.answer18}" data-audit="yes" />
				...
				<ul class="questions">
					<li>
						...
						<form:hidden path="answer19" id="answer19" value="${SurveyDTO.answer19}" data-audit="yes" />
						<div class="answer" data-answer="answer19"></div>
					</li>
					<li>
						<span class="number">20</span>
						<div class="question"><spring:message code="survey.q20" /></div>
						<form:hidden path="answer20" id="answer20" value="${SurveyDTO.answer20}" data-audit="yes" />
