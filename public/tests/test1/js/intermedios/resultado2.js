circo.intermedios.Resultado2 = function(canvas)
{
	...
	function pulsarBotonSi() {
		registrarDato("AGE_SUCCESS", "TRUE");
		registrarDato("AGE_VALUE", edadOriginal);
		pulsado = true;
	};
	...
	function pulsarBotonNo() {
		...
		if (resultado.edad != edadOriginal) {
			registrarDato("AGE_SUCCESS", "FALSE");
			registrarDato("AGE_VALUE", edad);
			pulsado = true;
		}
	};
